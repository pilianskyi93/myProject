...
public class StudentTest {
    public static void main(String[] args) {
        Student stud1 = new Student(2802, 4, 80, 75, 92, "John", "Smith");
        Student stud2 = new Student(2610, 3, 65, 75, 80, "Carlos", "Himenes");
        Student stud3 = new Student(2889, 5, 95, 85, 100, "Phillip", "Jhonson");

        System.out.println("John Smith (ID: " + stud1.studentId + " , Year: " + stud1.year + ") average grade: " + stud1.calculateAverageGrade());
